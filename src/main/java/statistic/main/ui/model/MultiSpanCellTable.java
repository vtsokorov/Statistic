...
public class MultiSpanCellTable extends JTable {
  ...
  public MultiSpanCellTable(TableModel model) {
    ...
    AttributiveCellRenderer centerRenderer = new AttributiveCellRenderer();
    centerRenderer.setHorizontalAlignment( JLabel.CENTER );
    this.setDefaultRenderer(LocalDate.class, centerRenderer);
    this.setDefaultRenderer(BigDecimal.class, centerRenderer);
  }
  ...
  public void setModel(TableModel dataModel) 
  {
        ...
        {
            ColumnGroup g_name = new ColumnGroup("Абсолютный прирост");
            g_name.add(cm.getColumn(2));
            g_name.add(cm.getColumn(3));

            ColumnGroup g_lang = new ColumnGroup("Темп роста");
            g_lang.add(cm.getColumn(4));
            g_lang.add(cm.getColumn(5));

            ColumnGroup g_other = new ColumnGroup("Темп прироста");
